...
public class TC001_CreateSavingsAccount extends BaseClass {
	...
	public void addNewSavingsAccount() {
		...
		Map<String, String> excelData = data.readData("New Account", "TC001", "testCaseId");
		...
		logger.info("Account Generated Succesfully is Displayed ");
		ExcelWriter writer = new ExcelWriter();
		writer.updateCell("New Account","Account_ID", "TC001", page.getAccountId());
		writer.updateCell("New Account","Customer_ID", "TC001", page.getCustomerId());
		writer.updateCell("New Account","Customer_Name", "TC001", page.getCustomerName());
		writer.updateCell("New Account","Email", "TC001", page.getEmailId());
		writer.updateCell("New Account","Current_Amount", "TC001", page.getCurrentAmount());
